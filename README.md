...
The lines tracking sum of percentage successful and sum of percentage failed resulted reflections of each other. Overall, the chart shows that successful campaigns are more likely to have smaller monetary goals while failed campaigns tend to have larger monetary goals. 
